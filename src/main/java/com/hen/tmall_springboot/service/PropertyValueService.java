...
public class PropertyValueService {
    ...
    public void init(Product product) {
        PropertyValueService propertyValueService = (PropertyValueService) SpringContextUtil.getBean(PropertyValueService.class);
    ...
    public PropertyValue getByProductAndProperty(Product product, Property property) {
        return this.propertyValueDAO.getByProductAndProperty(product, property);
    }
    ...
    public void update(PropertyValue bean) {
        this.propertyValueDAO.save(bean);
    }

    @CacheEvict(allEntries = true)
    public void delete(PropertyValue bean) {
        this.propertyValueDAO.delete(bean);
    }
}
